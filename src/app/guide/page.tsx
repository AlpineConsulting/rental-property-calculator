...
export default function ResourcesPage() {
  ...
  const insurance = [
    ...
    },
    {
      ...
      description: 'Specialized short-term rental insurance for Airbnb and VRBO properties.',
      features: ['STR-specific coverage', 'Guest liability', 'Income protection'],
      url: '/go/proper-insurance',
      rating: 4.6
    }
  ];
      ...
      <section className="bg-gradient-to-r from-blue-600 to-green-600 text-white pt-32 pb-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Carefully selected partners to help you finance, analyze, insure, and manage your rental properties.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 px-4 bg-yellow-50 border-b border-yellow-200">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm text-yellow-800">
            <strong>Affiliate Disclosure:</strong> We may earn commissions from some of these partners at no cost to you. 
            This helps us keep our calculator free. We only recommend services we believe provide value to investors.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center mb-8">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Financing Partners</h2>
              <p className="text-gray-600">DSCR loans and hard money lenders for rental property investors</p>
            </div>
          </div>
            ...
            {lenders.map((lender, index) => (
              <div key={index} className="bg-white rounded-2xl border-2 border-gray-200 hover:border-blue-400 hover:shadow-xl transition-all p-6">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl"
                >
                  Get Pre-Qualified
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-green-600">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Use our free calculator to run the numbers, then connect with our partners for financing and data.
          </p>
          <Link 
            href="/#calculator"
